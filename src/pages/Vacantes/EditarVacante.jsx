...
import { clearMessageVacante } from "@/store/vacantes";
...
export const EditarVacante = () => {
  ...
  const { loading, message, status, vacante } = useSelector(
    (state) => state.vacantes
  );
  const { getByVacanteId, editVacante } = useVacanteStore();
  ...
  const vacanteFormFields = {
    ...
    postulacion: vacante?.postulacion || "",
  ...
  const EditVacanteSubmit = (values) => {
    dispatch(
      editVacante({
        id,
  ...
  return (
    <div className="p-5">
      <Indicador
        Nombre="Vacante"
        href="/vacantes"
        ide={`/editar-vacante/${vacante.id}`}
        Pantalla="Editar vacante"
      />
      <div className="flex mt-8">
        <h2 className="text-3xl font-bold">Actualizar Vacante</h2>
      </div>
      <div>
        <Formik
          initialValues={vacanteFormFields}
          onSubmit={EditVacanteSubmit}
              ...
              <div className="grid md:grid-cols-2 mt-8 gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    disabled={loading}
                    name="modalidad"
                    defaultValue={vacante.modalidad}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    disabled={loading}
                    name="postulacion"
                    defaultValue={vacante.postulacion}
